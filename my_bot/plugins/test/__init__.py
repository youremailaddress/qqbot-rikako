...
async def _(bot: Bot, event: Event):
    ...
    await matcher.send(makeCardImage("https://pixiv.re/99796471.jpg"))
    await matcher.send(makeCardImage("https://i.pixiv.re/img-original/img/2022/05/12/01/49/58/98282918_p2.jpg"))
